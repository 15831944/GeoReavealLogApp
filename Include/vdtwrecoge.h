...
/*****************************************************************************/
double  _declspec(dllexport)_cdecl DTWDistanceFun(double *A,int I,double *B,int J,int r);
...
/* tt为样本之间距离的阈值，自行定义
/*****************************************************************************/
int  _declspec(dllexport)_cdecl DTWTemplate(double *A,int I,double *B,int J,double *temp,int turn,double tt,double *rltdistance);
...
void  _declspec(dllexport)_cdecl VectorInit(mvector *A,int dim);

/*****************************************************************************/
/* VectorAdd(mvector *A,mvector *B,mvector *C)
/* 向量加法，结果存放在C中
/*****************************************************************************/
void  _declspec(dllexport)_cdecl VectorAdd(mvector *A,mvector *B,mvector *C);
/*****************************************************************************/
/* VectorDistance,用于求两个向量之间的距离，欧氏距离
/* A和B是待求距离的两个向量
/*****************************************************************************/
double  _declspec(dllexport)_cdecl VectorDistance(mvector *A,mvector *B);
...
/* tt为样本之间距离的阈值，自行定义
/*****************************************************************************/
int _declspec(dllexport)_cdecl VDTWTemplate(mvector *A,int I,mvector *B,int J,mvector *temp,int turn,double tt,double *rltdistance);
