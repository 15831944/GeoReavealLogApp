...
// 
class AFX_EXT_CLASS DockingMarkers;
// 
...
/////////////////////////////////////////////////////////////////////////////
//
class AFX_EXT_CLASS DockingMarkersDrawBase : public DockingMarkersDraw
{protected:
		// DockingMarkersDraw.
	virtual void DrawMarker(DockingMarkers *pObj, CDC *pDC, CRect const *pRect, DOCKMARKER marker, CImageList *pImageList, bool bHighlight, bool bDisable);
	virtual void DrawSelectWindow(DockingMarkers *pObj, CDC *pDC, CRect const *pRect, bool bTab, bool bTop, int iTabHeight);
...
/////////////////////////////////////////////////////////////////////////////
//
class AFX_EXT_CLASS DockingMarkersDraw_custom1 : public DockingMarkersDrawBase
{protected:
	virtual int GetSelectBarBorderWidth(DockingMarkers *pObj);
	virtual int GetSelectFrameWidth(DockingMarkers *pObj);
...
/////////////////////////////////////////////////////////////////////////////
//
class AFX_EXT_CLASS DockingMarkersDraw_VS2003 : public DockingMarkersDrawBase
{protected:
	virtual int GetSelectFrameWidth(DockingMarkers *pObj);
};
/////////////////////////////////////////////////////////////////////////////
// 
class AFX_EXT_CLASS DockingMarkersDraw_VS2005 : public DockingMarkersDrawBase
{protected:
	virtual int GetSelectBarBorderWidth(DockingMarkers *pObj);
};
/////////////////////////////////////////////////////////////////////////////
// 
class AFX_EXT_CLASS DockingMarkersDraw_VS2008 : public DockingMarkersDrawBase
{
};
/////////////////////////////////////////////////////////////////////////////
//
class AFX_EXT_CLASS DockingMarkersDraw_VS2010 : public DockingMarkersDrawBase
{protected:
	virtual int GetSelectBarBorderWidth(DockingMarkers *pObj);
	virtual COLORREF GetSelectBarInsideColor(DockingMarkers *pObj);
