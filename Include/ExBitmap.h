// EnBitmap.h: interface for the CExBitmap class.
//
//////////////////////////////////////////////////////////////////////
#ifndef __ENBITMAP_H__
#define __ENBITMAP_H__
...
class AFX_EXT_CLASS CExBitmap : public CBitmap  
{
public:
	CExBitmap(COLORREF crBkgnd = RGB(255, 255, 255));
	virtual ~CExBitmap();
