// SysDisk.h : header file
#if !defined(__SysDisk_H__)
#define __SysDisk_H__

// 全局变量的定义
static DWORD HardDiskInformationData[256];

/////////////////////////////////////////////////////////////////////////////
// CSysDisks window
class CSysDisk: public CDocument     // 
{
	// Construction
public:
	CSysDisk();
...
public:
	...
	char *ConvertToString (int firstIndex, int lastIndex);
	void PrintIdeInfo (int drive,char HardDriveSerialNumber [1024]);
	
    BOOL DoIDENTIFY (HANDLE A,PSENDCMDINPARAMS B,PSENDCMDOUTPARAMS C,
		BYTE D, BYTE E,PDWORD F);
