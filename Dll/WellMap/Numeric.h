...
class NumericException : public CBaseException
{
public:
	NumericException() throw() : CBaseException(_T("Numeric Exception")) {}
	NumericException(std::string message) throw() : CBaseException(message) {}
};
