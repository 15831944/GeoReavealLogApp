...
class InterpolaterException : public CBaseException
{
public:
	InterpolaterException(string message) throw() : CBaseException(message) {}
	InterpolaterException(string message, string location) throw() : CBaseException(message, location) {}
};
