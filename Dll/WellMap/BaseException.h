...
class CBaseException : public std::runtime_error
{
public:
	CBaseException() throw() : runtime_error("error") {}
	CBaseException(std::string message) throw() : runtime_error(message) {}
	CBaseException(std::string message, std::string location) throw() : std::runtime_error(message+location) {}
