...
class CImageException : public CBaseException
{
public:
	CImageException() throw() : CBaseException(_T("ImageException")) {}
	CImageException(std::string message) throw() : CBaseException(message) {}
	CImageException(std::string message, std::string location) throw() : CBaseException(message, location) {}
};
