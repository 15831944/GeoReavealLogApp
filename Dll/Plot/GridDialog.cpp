...
const DWORD CGridPage::m_nHelpIDs[] = 
{
	IDC_GRID_SELECT_ITEM, HID_GRID_ITEM,
	IDC_GRID_LINENUM, HID_GRID_NUM,
	IDC_GRID_LINE_COLOR, HID_GRID_COLOR,
	IDC_GRID_LINE_WIDTH, HID_GRID_WIDTH,
	IDC_GRID_LEFT_VALUE, HID_GRID_LEFTSCALE,
	IDC_GRID_RIGHT_VALUE, HID_GRID_RIGHTSCALE,
	IDC_GRID_LINE_TYPE, HID_GRID_LINESCALE,
	IDC_GRID_LOG_TYPE, HID_GRID_LOGSCALE,
	IDC_GRID_VERLINE, HID_GRID_VERLINE,
	IDC_GRID_HORLINE, HID_GRID_HORLINE,
	IDC_TRACK_GRID, HID_GRID_PREVIEW,
	0, 0
};

CGridPage::CGridPage(CGridObj* pGridObj)
	: CCSPropertyPage(CGridPage::IDD)
{
...
BEGIN_MESSAGE_MAP(CGridPage, CCSPropertyPage)
...
void CGridPage::OnMouseMove(UINT nFlags, CPoint point)
{
	...
	CCSPropertyPage::OnMouseMove(nFlags, point);
	int i = HitTest(point);
	if (i != -1) 
...
void CGridPage::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	CCSPropertyPage::OnLButtonDown(nFlags, point);
	c_down = point;
}
...
void CGridPage::OnLButtonUp(UINT nFlags, CPoint point)
{
	...
	CCSPropertyPage::OnLButtonUp(nFlags, point);
