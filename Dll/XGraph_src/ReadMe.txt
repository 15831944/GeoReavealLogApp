========================================================================
       DYNAMIC LINK LIBRARY : XGRAPH
========================================================================


Diese XGRAPH-DLL hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre XGRAPH-Anwendung bilden.
...
StdAfx.h, StdAfx.cpp
    ...
    XGRAPH.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
