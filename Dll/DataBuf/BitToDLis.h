...
private:
	...
	void GetDlisFDataIndexFromBit(); //取得DLIS数据分帧信息
	void SetDlisChannelsFromBit(); //设置DLIS通道信息
	...
	void SetDlisFrameFromBit(); //设置DLIS帧
	void SetAxisFromBit(); //设置轴
	void BitDataToDlis(); //BIT数据向DLIS转换
