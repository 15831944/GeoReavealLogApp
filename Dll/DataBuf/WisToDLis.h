...
private:
	...
	void GetDlisFDataIndexFromWis(); //取得DLIS数据分帧信息
	void SetDlisChannelsFromWis(); //设置DLIS通道信息
	...
	BYTE WisRepCodeToDlis(int RepCode); //设置表示码
	void SetDlisFrameFromWis(); //设置DLIS帧
	void SetAxisFromWis(); //设置轴
	void WisDataToDlis(); //WIS数据向DLIS转换
