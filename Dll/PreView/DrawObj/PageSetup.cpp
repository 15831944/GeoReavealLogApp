...
CPageSetup::CPageSetup(CLogPlotDoc* pDoc1,CWnd* pParent)
...
//	DDV_MinMaxUInt(pDX, m_Width, 10, 10000);
	...
	DDX_Text(pDX, IDC_PAGE_HEIGHT, m_Height);
	DDX_Text(pDX, IDC_HEADBOTTOM_SPACE, m_HeadBottomSpace);
	DDX_Text(pDX, IDC_HEADTOP_SPACE, m_HeadTopSpace);
	//}}AFX_DATA_MAP
}
...
void CPageSetup::OnOK() 
{
	...
	m_HeadTopSpace = (int) (m_HeadTopSpace / 0.254 + 0.5);
	m_HeadBottomSpace = (int) (m_HeadBottomSpace / 0.254 + 0.5);
	m_Height = (int) (m_Height / 0.254 + 0.5);
...
BOOL CPageSetup::OnInitDialog() 
{
	...
	m_HeadTopSpace = (int) (pDoc->m_HeadTopSpace * 0.254 + 0.5);
	m_HeadBottomSpace = (int) (pDoc->m_HeadBottomSpace * 0.254 + 0.5);
	m_Height = (int) (pDoc->m_HeadRect.Height() * 0.254 + 0.5);
