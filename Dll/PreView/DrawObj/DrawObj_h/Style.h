...
extern void HWFillCurve(LPPOINT point1, LPPOINT point2, int nPointNum,int nLthNo,COLORREF nColor,
													CPoint org, CDC* pDC, int nFillMode,COLORREF nBkColor=0xffffff);
extern void FillCurve(LPPOINT point1, LPPOINT point2, int nPointNum,int nLthNo,COLORREF nColor,
												  CPoint org, CDC* pDC, int nFillMode,COLORREF nBkColor=0xffffff);
extern void FillCurve(int x, LPPOINT point, int nPointNum, int nLthNo,COLORREF nColor,
												  CPoint org, CDC* pDC,int nFillMode,COLORREF nBkColor=0xffffff);
extern void FillRoundRect(CRect rect, CPoint roundNess,int nLthNo,COLORREF nColor,
													  CPoint org, CDC* pDC,COLORREF nBkColor=0xffffff);
extern void FillRoundRect(int xl, int yt, int xr, int yb, CPoint roundNess, int nLthNo,COLORREF nColor,
													  CPoint org,CDC* pDC,COLORREF nBkColor=0xffffff);
extern void LithFillBox(int xl, int yt, int xr, int yb, int nLthNo,COLORREF nColor,
													CPoint org,CDC* pDC1,COLORREF nBkColor=0xffffff);
extern void LithFillBox(CRect rect, int nLthNo,COLORREF nColor,
													CPoint org,CDC* pDC1,COLORREF nBkColor=0xffffff);
extern void FillEllipse(CRect rect, int nLthNo,COLORREF nColor,
													CPoint org, CDC* pDC,COLORREF nBkColor=0xffffff);
extern void FillEllipse(int xl, int yt, int xr, int yb,int nLthNo,COLORREF nColor,
													CPoint org, CDC* pDC,COLORREF nBkColor=0xffffff);
extern void LithFillPoly(LPPOINT point, int nPointNum,int nLthNo,COLORREF nColor,
													 CPoint org,CDC* pDC1,COLORREF nBkColor=0xffffff);
...
//extern CString m_szLithDB;
//得到岩性符号数据short int[32*32]
extern DWORD GetLithSymbol(DWORD iLithID,DWORD nLen,char *pBuf);
