...
class AFX_EXT_CLASS CCheckLogin
{
...
public:
	...
	CString str_HardDesk_Form;          //说明硬盘是主动盘还是辅动盘
    CString str_Controller;             //说明所取的信息来源于电脑上的第几个硬
public:
	BOOL GetLogTopRegInt(CString szKey,LPCTSTR lpszEntry,int& nValue);
