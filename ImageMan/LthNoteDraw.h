...
{                  
public:
	CLthNotePoint(CRect rect, COLORREF LthNoteColor,LOGFONT LthNoteFont,CString NoteStr,CImageManDoc* pDocumnet);
	void Draw(CDC* pDC);
	CImageManDoc* pDoc;
	CRect m_Rect;
	CString m_NoteStr;
...
public:
	CLthNoteObj();
	CLthNoteObj(CString strPathName, const CRect& rect,CDrawObj* pParentObj,CImageManDoc* pDocument);
	~CLthNoteObj();
