...
CAzimFreqObj::CAzimFreqObj(CString szPathName, const CRect& rect,CDrawObj* pParentObj,CImageManDoc* pDoc)
...
void CAzimFreqObj::CreatePoint()
{
	...
	CFIDIO* pDdirFIDIO = new CFIDIO(StrAzi);
	if(pDdirFIDIO->Open()) 
		bOpen1=TRUE;
	if(pDangFIDIO->Open()) 
		bOpen2=TRUE;
