...
{                  
public:
	CVectorPoint(CPoint Point,float Dep,float Dip,float Dir,
		CString Flag,COLORREF Color,BOOL );
...
public:
	CMarkVectorObj();
	CMarkVectorObj(CString strPathName, const CRect& rect,CDrawObj* pParentObj,CImageManDoc* pDocument);
	~CMarkVectorObj();
	float m_MinGrade;
