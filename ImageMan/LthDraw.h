...
{                  
public:
	CLthPoint(CRect rect, int LithNo,unsigned long ColorNo,int LithWidth,CImageManDoc* pDocument );
...
public:
	CLthObj();
	CLthObj(CString strPathName, const CRect& rect,CDrawObj* pParentObj,CImageManDoc* pDocument);
	~CLthObj();
